function start() {
    function c(passed_month, passed_year, calNum) {
        var calendar = calNum == 0 ? calendars.cal1 : calNum == 1 ? calendars.cal2 : calendars.cal3;
        ...
        for (var cell = 0; cell < 42 - r; cell++) { // 42 date-cells in calendar
            if (cell >= calMonthArray.length) {
                ...
                if (
                    ...
                    } else if (checkSat(iter_date)) {
                        var m = '<div class="Sa">';
                    } else if (checkSun(iter_date)) {
                        var m = '<div class="Su">';
                    } else {
                        var m = '<div>';
                    }
    ...
    function checkSun(e) {
        return e.getDay() == 6 ? true : false;
    }

    function checkSat(e) {
        return e.getDay() == 5 ? true : false;
    }
    ...
    function b() {
        ...
        var next1Dates = getAdjacentMonth(nextMonth, nextYear, "next");
        next1Month = next1Dates[0];
        next1Year = next1Dates[1];
    }
    ...
    var switchButton = $(".header").find('.switch-month');
    ...
    c(next1Month, next1Year, 2);
    switchButton.on("click", function () {
        var clicked = $(this);
        var generateCalendars = function (e) {
            var nextDatesFirst = getAdjacentMonth(month, year, e);
            var nextDatesSecond = getAdjacentMonth(nextMonth, nextYear, e);
            var nextDatesThird = getAdjacentMonth(next1Month, next1Year, e);
            month = nextDatesFirst[0];
            year = nextDatesFirst[1];
            nextMonth = nextDatesSecond[0];
            nextYear = nextDatesSecond[1];
            next1Month = nextDatesThird[0];
            next1Year = nextDatesThird[1];
